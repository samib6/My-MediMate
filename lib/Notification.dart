...
Future<void> scheduleDailyTenAMNotification(int hr,int min,int sec) async {
  print("inside noti");
await flutterLocalNotificationsPlugin.zonedSchedule(
0,
...
tz.TZDateTime scheduledDate = _nextInstanceOfTenAM(3,0,0);
...
class _HomePageState extends State<HomePage> {
              ...
              children: <Widget>[
                ...
                PaddedRaisedButton(
                  ...
                  'Schedule daily 10:00:00 am notification in your '
                      'local time zone',
                  onPressed: () async {
                    await _scheduleDailyTenAMNotification(4,2,0);
                  },
                ),
                PaddedRaisedButton(
                  buttonText:
  ...
  Future<void> _scheduleDailyTenAMNotification(int hr,int min,int sec) async {
    await flutterLocalNotificationsPlugin.zonedSchedule(
        0,
        'daily scheduled notification title',
        'daily scheduled notification body',
